...
function getAttackTier(row, profileArray) {
    ...
    var tier = Math.ceil((total - bracket) / bracket);
    if (tier > maxAttacks) {
        tier = maxAttacks;
    }
    return tier;

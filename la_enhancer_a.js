        ...
        if (!checkIfNextVillage()) {
            if (userset[s.smart_ab]) {
                ...
                if (smartAbStock.light >= 1 && aButton.html() != undefined) {
                    button = aButton;
                    smartAbStock.light--;
                } else if (smartAbStock.heavy >= 1 && bButton.html() != undefined) {
                    button = bButton;
                    smartAbStock.heavy--;
                } else {
                    window.top.UI.InfoMessage("LC and HC used up, switching villages...", 800);
                    if (cansend && filtersApplied) {
                        getNewVillage("n");
                    }
                    return;
